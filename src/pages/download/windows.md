...
- [Installer (x86-64) (.exe)](https://github.com/PrismLauncher/PrismLauncher/releases/download/11.1.0/PrismLauncher-Windows-MinGW-w64-Setup-11.1.0.exe)
- [Installer (ARM64) (.exe)](https://github.com/PrismLauncher/PrismLauncher/releases/download/11.1.0/PrismLauncher-Windows-MinGW-arm64-Setup-11.1.0.exe)
