...
```bash
curl -LO https://github.com/PrismLauncher/PrismLauncher/releases/download/10.0.3/PrismLauncher-Linux-x86_64.AppImage
...
```bash
curl -LO https://github.com/PrismLauncher/PrismLauncher/releases/download/10.0.3/PrismLauncher-Linux-aarch64.AppImage
