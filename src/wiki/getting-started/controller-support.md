...
* Please ensure that you comfortable with the mod installation process within PrismLauncher.
...
It can be be installed using PrismLauncher's mod downloader function either with Modrinth (recommended) or CurseForge.
...
Controllable can be be installed using PrismLauncher's mod downloader function from the **CurseForge** service.
