    ...
    <div class="column">
      <div>
       ...
       <div class="center notification type-info">
         ...
         <p>Support will be removed after 9.x. Users are encouraged to update to the Qt 6 builds listed below</p>
       </div>
     </div>
    </div>
    <div class="column">
...
We offer a `flake.nix`, containing both packages and overlays for the launcher

For a full explanation and usage examples, see [nix/README.md](https://github.com/PrismLauncher/PrismLauncher/blob/develop/nix/README.md).

```bash
nix profile install 'nixpkgs#prismlauncher'
```

<details>
  <summary>In a NixOS configuration</summary>
      ...
      nixosConfigurations.foo = nixpkgs.lib.nixosSystem {
        modules = [
          ...
          (
            ...
            in
            {
              environment.systemPackages = [ prismlauncher.packages.${system}.prismlauncher ];
            }
          )
        ];
      };
...
An expression is available for Linux and macOS
