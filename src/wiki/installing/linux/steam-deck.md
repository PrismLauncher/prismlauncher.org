...
- If you want Minecraft to launch without the PolyMC launcher add `-l <instance-id>` in your PolyMC's launch option in steam, find out more about CLI launch options [here](https://polymc.org/wiki/getting-started/command-line-interface/)
