...
scoop install polymc</code></pre>
  ...
  <div class="card">
    <h1>MacOS</h1>
    <p><a class="button" href="https://github.com/PolyMC/PolyMC/actions">Download</a></p>
  </div>
  <div class="card">
    <h1>Linux</h1>
    ...
    <p><a class="button" href="https://packages.polymc.org/latest/appimage/" >AppImage (Portable)</a>
    <a href="https://packages.polymc.org/latest/appimage/PolyMC-latest-x86_64.AppImage.sha256">AppImage SHA256</a></p>
    <p><a class="button" href="https://packages.polymc.org/latest/appimage/" >Download (Portable)</a></p>
