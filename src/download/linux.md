...
RPM packages are available on [Copr](https://copr.fedorainfracloud.org/coprs/g3tchoo/prismlauncher/). Please note that you must have the EPEL repositories enabled, and if you don't, please do so [here](https://www.redhat.com/sysadmin/install-epel-linux).
