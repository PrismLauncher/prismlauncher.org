...
There are per-commit development builds available [here](https://github.com/placeholdermc/PrismLauncher/actions). Debug information is present within the binaries, making their file sizes larger than otherwise normal.
