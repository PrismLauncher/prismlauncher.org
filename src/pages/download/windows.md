...
- [Installer (x86-64) (.exe)](https://github.com/PrismLauncher/PrismLauncher/releases/download/10.0.2/PrismLauncher-Windows-MinGW-w64-Setup-10.0.2.exe)
- [Installer (ARM64) (.exe)](https://github.com/PrismLauncher/PrismLauncher/releases/download/10.0.2/PrismLauncher-Windows-MinGW-arm64-Setup-10.0.2.exe)
