...
- [Installer (x86-64) (.exe)](https://github.com/PrismLauncher/PrismLauncher/releases/download/11.0.3/PrismLauncher-Windows-MinGW-w64-Setup-11.0.3.exe)
- [Installer (ARM64) (.exe)](https://github.com/PrismLauncher/PrismLauncher/releases/download/11.0.3/PrismLauncher-Windows-MinGW-arm64-Setup-11.0.3.exe)
