...
If it is missing, you can find it by right clicking on your instance in PrismLauncher and selecting the **Edit Instance** option in the menu.

## <img src="https://raw.githubusercontent.com/QuiltMC/art/master/brand/svg/quilt_logo_dark.svg" height="20"> Quilt

For installing Quilt in PrismLauncher, follow the [quilt wiki](https://quiltmc.org/install/prismlauncher/).
