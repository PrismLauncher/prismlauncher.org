...
<div class="download-content">
    ...
    <div class="column">
      <div>
        ...
        <a class="button size-large" href="https://github.com/PrismLauncher/PrismLauncher/releases/download/{{ version.current }}/PrismLauncher-macOS-Legacy-{{ version.current }}.tar.gz">Download Legacy (from High Sierra to Catalina)</a>
      </div>
    </div>
    <div class="column">
